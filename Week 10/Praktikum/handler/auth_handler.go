...
// @Accept json
// @Produce json
// @Param credentials body model.RegisterRequest true "Register credentials (username, password, and role)"
// @Success 201 {object} model.RegisterResponse "User registered successfully"
// @Failure 400 "Invalid body"
// @Failure 401 "User already exists"
// @Failure 500 "Failed to generate token"
